...
def experiments():
    experiments = [
            ...
            'comments': [{'insert': '\xa0\xa0\xa0First 12 of 96 files from barcoding technical experiment (Primity)\n\n'}]
            },
            {'_id': '5d5faa686d24fd0bf35129b1',
            'name': 'with-reagents',
            'uploader': {'_id': '5d366077a1789f7d6653075c',
                         'username': 'gegnew',
                         'email': 'g.egnew@gmail.com',
                         'firstName': 'Gerrit',
                         'lastName': 'Egnew'},
            ...
            'retentionPolicy': {'history': []},
            'locked': False,
            'primaryResearcher': {'_id': '5d366077a1789f7d6653075c',
                                  'username': 'gegnew',
                                  'email': 'g.egnew@gmail.com',
                                  'firstName': 'Gerrit',
                                  'lastName': 'Egnew'
