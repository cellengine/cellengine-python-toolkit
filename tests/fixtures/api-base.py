...
def client():
    with responses.RequestsMock() as resps:
        resps.add(responses.POST, base_url+'signin',
                  json={"token": "s:qbpXFuiS4zBujLjLUx4K8pldGl4hdqrW",
...
def experiment(client, experiments):
    with responses.RequestsMock() as resps:
        resps.add(responses.GET, base_url+'experiments/5d38a6f79fae87499999a74b',
                  json=experiments[0])
